...
class DoctorDetailPage extends StatefulWidget {
  DoctorDetailPage({Key key, @required this.model}) : super(key: key);
      ...
      body: SafeArea(
        ...
        child: Stack(
          ...
          children: <Widget>[
            ...
            //   child: CircleAvatar(
            //     radius: 150,
            //     backgroundImage: customAdvanceNetworkImage(model.image),
            //   ),
            // ),
            ...
            ClipRRect(
              ...
              child: Container(
                ...
                child: customNetworkImage(model.image, fit: BoxFit.cover),
              ),
            ).p(8),
